...
/*
  ...
  //lossModel->SetLoss (nodes.Get (1)->GetObject<MobilityModel> (), nodes.Get (0)->GetObject<MobilityModel> (), 50); // set symmetric loss 2 <-> 1 to 50 dB
  ...
  NetDeviceContainer devices = wifi3.Install (wifiPhy, wifiMac, nodes);*/
  ...
  devices = wifi3.Install (phy3, mac3, nodes);
