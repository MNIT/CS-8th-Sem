...
void experiment (bool enableCtsRts)
{
  ...
  UintegerValue ctsThr = (enableCtsRts ? UintegerValue (10) : UintegerValue (2000));
  ...
  lossModel->SetDefaultLoss (250); // set default loss to 200 dB (no link)
  lossModel->SetLoss (nodes.Get (0)->GetObject<MobilityModel> (), nodes.Get (1)->GetObject<MobilityModel> (), 80); 
  lossModel->SetLoss (nodes.Get (2)->GetObject<MobilityModel> (), nodes.Get (1)->GetObject<MobilityModel> (), 80); 
